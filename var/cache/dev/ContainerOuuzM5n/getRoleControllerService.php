...
class getRoleControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.ghRfMDm'] ?? $container->load('get_ServiceLocator_GhRfMDmService'))->withContext('App\\Controller\\RoleController', $container));
