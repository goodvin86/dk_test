...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'console.command.public_alias.mybuilder.cronos_bundle.command.dump' => 'getConsole_Command_PublicAlias_Mybuilder_CronosBundle_Command_DumpService',
            'console.command.public_alias.mybuilder.cronos_bundle.command.replace' => 'getConsole_Command_PublicAlias_Mybuilder_CronosBundle_Command_ReplaceService',
            ...
            'mybuilder.cronos_bundle.annotation_cron_exporter' => 'getMybuilder_CronosBundle_AnnotationCronExporterService',
            'mybuilder.cronos_bundle.cron_process_updater' => 'getMybuilder_CronosBundle_CronProcessUpdaterService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/bw/active-menu-item-bundle/src/Twig/BWExtension.php';
    ...
    protected static function getTwigService($container)
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/security-bundle/Resources/views'), '!Security');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/bw/active-menu-item-bundle/src/Resources/views'), 'BWActiveMenuItem');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/bw/active-menu-item-bundle/src/Resources/views'), '!BWActiveMenuItem');
        ...
        $instance->addExtension(new \BW\ActiveMenuItemBundle\Twig\BWExtension($f));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'BWActiveMenuItemBundle' => 'BW\\ActiveMenuItemBundle\\BWActiveMenuItemBundle',
                'StimulusBundle' => 'Symfony\\UX\\StimulusBundle\\StimulusBundle',
                'MyBuilderCronosBundle' => 'MyBuilder\\Bundle\\CronosBundle\\MyBuilderCronosBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'BWActiveMenuItemBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/bw/active-menu-item-bundle/src'),
                    'namespace' => 'BW\\ActiveMenuItemBundle',
                ],
                'StimulusBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/symfony/stimulus-bundle'),
                    'namespace' => 'Symfony\\UX\\StimulusBundle',
                ],
                'MyBuilderCronosBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/mybuilder/cronos-bundle'),
            ...
            'mybuilder.cronos_bundle.exporter_config' => [
                'key' => 'unique-key',
                'mailto' => 'your@email.com',
                'path' => '/bin:/usr/local/bin',
                'executor' => '/usr/local/bin/php',
                'console' => (\dirname(__DIR__, 4).'/bin/console'),
                'shell' => '/bin/bash',
            ],
            ...
            'console.command.ids' => [
                0 => 'console.command.public_alias.mybuilder.cronos_bundle.command.dump',
                1 => 'console.command.public_alias.mybuilder.cronos_bundle.command.replace',
            ],
        ];
    }
}
